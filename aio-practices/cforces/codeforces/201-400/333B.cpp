...
//all of the other oens work because they'll never collide if arrange optimally (i.e. if one near the top goes l-r, the one near the bottom on the same side should go down-up)